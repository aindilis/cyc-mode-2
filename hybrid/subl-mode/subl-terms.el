...
(defvar subl-mode-main-relation
 (list
  "instance"
  "subclass"
  "domain"
...
(defvar subl-mode-functions-non-relational-instances-and-classes
 (list
...
(defvar subl-mode-all-terms
 (append subl-mode-main-keyword subl-mode-main-relation
  subl-mode-functions-non-relational-instances-and-classes
  subl-mode-relations
  (list "-1" "<=>" "=>")))

(defvar subl-mode-commands-regex
 "\\(cyc-assert\\|cyc-query\\|constant-apropos\\)\\b"
 ;; (chomp
 ;;  (shell-command-to-string
 ;;   "/var/lib/myfrdcsa/codebases/minor/cyc-mode/hybrid/subl-mode/process/process.pl"))
 )

(defvar subl-mode-commands cyc-subl-function-names)
